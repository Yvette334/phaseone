...
function displayFavoriteBooks() {
    ...
    if (favoriteBooks.length === 0) {
        ...
        // Create book data (you might want to fetch this from an API or have a proper data structure)
        const bookData = {
        ...
        favoriteBooks.forEach(bookId => {
            ...
            if (book) {
                ...
                bookCard.className = 'overflow-hidden h-full flex flex-col border border-border rounded-lg bg-card hover:shadow-lg';
                bookCard.innerHTML = `
                    <div class="p-0">
...
function initFavorites() {
    ...
    // Add event listener to favorites button in nav
